...
$.lang.register('adventuresystem.stories.1.chapter.1', 'Your memory is vague, on the table is a small laptop playing a video: "My name is The Architect. The bank of Karabraxos is the most secure bank in the universe. You will rob the bank of Karabraxos!"');
$.lang.register('adventuresystem.stories.1.chapter.2', 'Unable to leave their minds blank, (caught) slowly feels their mind being drained as The Teller feeds on their thoughts.');
$.lang.register('adventuresystem.stories.1.chapter.3', 'We find ourselves back in the room we started in as the consciousness of (survivors) slowly comes back, only to wake up in our beds like nothing at all has happened.');
...
$.lang.register('adventuresystem.stories.2.chapter.3', 'Daym, that was a close call for losing a leg. But you\'ve deserved this (survivors)!');
...
$.lang.register('adventuresystem.stories.4.chapter.1', 'I think we have a much bigger threat on our hands than the cave we\'re in... It is half man, half bear, half pig... Don\'t Laugh, I\'M SUPER CEREAL!');
